...
export const SignUpCard = ({ setState }: SignUpCardProps) => {
  ...
  const onPasswordSignUp = (e: React.FormEvent<HTMLElement>) => {
    ...
    signIn("password", { name, email, password, flow: "signUp" })
      .catch(() => {
        setError(
          "Please ensure your password includes uppercase, lowercase, number, and special character. Then try again."
        );
      })
      .finally(() => {
        setPending(false);
    ...
    <Card className="w-full h-full p-8">
      ...
      <CardContent className="space-y-5 px-0 pb-0">
        ...
        <div className="flex flex-col gap-y-2.5">
          ...
          >
            <FcGoogle className="size-5 mr-4" />
          ...
          <Button
            ...
            className="w-full relative"
          >
            <FaGithub className="size-5 mr-4" />
